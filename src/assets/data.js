const work = [
  ...
  'Fire Pit Planning Tool\n\nAn engineering-focused planning app for designing custom masonry fire pits with build-ready calculations, safety guidance, and visual construction outputs.\n\nTech Stack: React 19, TypeScript, CSS.\n\nKey Achievements: Built a parametric designer with real-time geometry and material calculations, 3D and construction-oriented views, a detailed bill of materials and cost estimator, printable report flows, and project save and compare tools.',
  'Spot on Shelves\n\nA web app to help plan and visualize the placement of shelves, pictures and other wall mounted objects.\n\nTech Stack: React, TypeScript, Node.js, Express, MongoDB.\n\nKey Achievements: Built a user-friendly interface for shelf and picture hanging planning, provided real-time visualization of shelf layouts and PDF downloadable measurements and directions.',
  ...
  'NYT Letter Boxed Solver\n\nA React-based helper for the New York Times Letter Boxed puzzle that can auto-populate the current board and surface strong two-word and three-word solutions.\n\nTech Stack: React, JavaScript, CSS.\n\nKey Achievements: Built client-side filtering and pairing logic for large word lists, added current-puzzle auto-fill support, and optimized the search flow for responsive use across devices.',
  'NYT Spelling Bee Solver\n\nA mobile-first helper for the New York Times Spelling Bee puzzle that quickly surfaces candidate words from a compact single-input interface.\n\nTech Stack: React, JavaScript, CSS.\n\nKey Achievements: Designed a streamlined honeycomb input experience, tuned the interaction model for fast correction and entry, and shipped the solver as a lightweight front-end-only tool.',
  'NYT Wordle Helper\n\nA Wordle-style assistant that accepts letter feedback and suggests likely answers based on letter presence and letter position.\n\nTech Stack: React, JavaScript, CSS.\n\nKey Achievements: Recreated the familiar Wordle board interaction, built filtering logic around positional feedback, and packaged the solver as a fast browser-based daily companion.',
  'NYT Strands Helper\n\nA helper for the NYT Strands puzzle that auto-populates the daily board and assists with finding theme words from the current letter set.\n\nTech Stack: React, JavaScript, CSS.\n\nKey Achievements: Added current-puzzle auto population, built Strands-specific solving workflows, and shipped the tool as a quick daily-play companion.',
  ...
  'Pac-Man Clone\n\nA from-scratch Pac-Man clone focused on recreating the classic arcade feel with authentic ghost behaviors, power pellets, fruit bonuses, and local high-score tracking.\n\nTech Stack: Vanilla JavaScript, HTML, CSS.\n\nKey Achievements: Implemented individual ghost targeting logic, frightened and dead ghost state transitions, level reset and scoring systems, keyboard support for both WASD and arrow keys, and persistent high scores in localStorage.',
...
const repositories = [
  ...
  'https://github.com/MrJanHorak/letter-box-solver',
  ...
  'https://github.com/MrJanHorak/retro-game-pacman-clone',
...
const projectPics = [
  ...
  { type: 'single', images: ['./junctionAppSamp.gif'] },
  {
    type: 'multiple',
    images: [
      './projectImages/pacmanClone/pacmanclone1.png',
      './projectImages/pacmanClone/pacmanclone2.png',
      './projectImages/pacmanClone/pacmanclone3.png'
    ]
  },
